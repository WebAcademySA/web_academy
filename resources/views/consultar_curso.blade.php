...
<!--Titulos-->
	<div class="container row"><div class="col-md-6"><h3 class="til2">Consultar curso</h3></div><div class="col-md-6"><h3 class="til2">Nombre del curso</h3></div></div><div class="col-md-12"><hr/></div>
...
<div class="container row">
    ...
    <div class="form-inline form-group">
    	...
    	<div><input class="btn btn-primary guardar10" type="submit" name="buscar" value="Buscar"/></div>
		</form>
    </div>
<!--tabla-->
    <div col-md-6>
