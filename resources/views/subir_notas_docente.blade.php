...
<!--Titulos-->
<div class="container"><div><h3 class="tilnotas">Por favor ingrese la nota</h3></div><hr/></div>
@if($errors->any())
...
<div class="container row">
    <form  class="subirnotas" name="regalumno" method="post" action="{{ route('subir_notas_docente.store') }}">
        ...
        <div class="form-group celda2"><input class="form-control" id="Nombseg" type="text" name="periodo1" value="{{ null }}" pattern="[0-5]" placeholder="Primer Periodo" /></div>
        <div class="form-group celda2"><input class="form-control" id="primapel" type="text" name="periodo2" value="{{ null }}" pattern="[0-5]" placeholder="Segundo Periodo"/></div>
        <div class="form-group celda2"><input class="form-control" id="segunapel" type="text" name="periodo3" value="{{ null }}" pattern="[0-5]" placeholder="Tercer Periodo"/></div>
        <div class="form-group celda2"><input class="form-control" id="Dir2" type="text" name="periodo4" value="{{ null }}" pattern="[0-5]" placeholder="Cuarto periodo"/><input type="hidden" name="_token" value="{{ csrf_token() }}"></div>

        <button class="btn btn-primary guardarnotas" type="submit"/>Guardar</button>
    </form>
</div>
@endsection