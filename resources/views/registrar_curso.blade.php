...
@endif
	<form class="regcur" name="regcurso" method="post" action="{{ route('registrar_curso.store') }}">
    	<div class="celda form-group"><input class="form-control" id="Grad2" type="text" name="grado" pattern="^[0-9]+-[a-Z]+" placeholder="Grado *" required/></div>
        <div class="celda form-group"><input class="form-control" id="salo" type="text" name="aula" pattern="[0-9]{1,16}" placeholder="No. de salon *" required/></div><div><input type="hidden" name="_token" value="{{ csrf_token() }}"></div>
